...
public class Planet2 : UniverseEntity
{
    ...
    private void Start()
    {
        ...
        initialForce = new Vector3(massMultiple*Mathf.Pow(distanceFromStar, 0.5f), 0, 0);
    ...
    Vector3 GravitationalForce()
    {
        ...
        Debug.Log("Direction: " + distance.magnitude + ", " + gForce + ", Init F :" + initialForce.magnitude);
        return distance.normalized * gForce;
    }
